...
class _SliverStackParentData extends ParentData
...
class _RenderSliverStack extends RenderSliver
    with
  ...
  void setupParentData(covariant RenderObject child) {
    child.parentData = _SliverStackParentData();
  }
  ...
  void performLayout() {
    ...
    for (final child in _children.whereType<RenderSliver>()) {
      final parentData = child.parentData as _SliverStackParentData;
  ...
  double _computeChildMainAxisPosition(
    ...
    final childParentData = child.parentData as _SliverStackParentData;
...
class _SliverStack extends MultiChildRenderObjectWidget {
  _SliverStack({
    Key? key,
  ...
  @override
  _RenderSliverStack createRenderObject(BuildContext context) {
    return _RenderSliverStack()
  ...
  void updateRenderObject(
      BuildContext context, covariant _RenderSliverStack renderObject) {
    renderObject
      ..positionedAlignment = positionedAlignment
      ..textDirection = textDirection ?? Directionality.of(context)
      ..insetOnOverlap = insetOnOverlap;
...
/// A widget that controls where a box child of a [_SliverStack] is positioned.
///
/// A [SliverPositioned] widget must be a descendant of a [_SliverStack], and the path from
/// the [SliverPositioned] widget to its enclosing [_SliverStack] must contain only
/// [StatelessWidget]s or [StatefulWidget]s (not other kinds of widgets, like
/// [RenderObjectWidget]s).
class SliverPositioned extends ParentDataWidget<_SliverStackParentData> {
  ...
  void applyParentData(RenderObject renderObject) {
    assert(renderObject.parentData is _SliverStackParentData);
    final parentData = renderObject.parentData as _SliverStackParentData;
  ...
  @override
  Type get debugTypicalAncestorWidgetClass => _SliverStack;
}

/// [SliverAnimatedSwitcher] sets up an [AnimatedSwitcher] widget such that
/// it can be used as a sliver by using [_SliverStack] and [SliverFadeTransition]
///
