...
class DashboardApi {
    ...
    Future<Response<Dashboard>> getDashboard(
        ...
        final String _path = '/api/v1/dashboard/room/{roomId}'.replaceAll('{' r'roomId' '}', roomId.toString());
        ...
        return _dio.request<dynamic>(
            ...
            final serializer = _serializers.serializerForType(Dashboard) as Serializer<Dashboard>;
            final data = _serializers.deserializeWith<Dashboard>(
                serializer,
    ...
    Future<Response<void>> saveDashboard(
        ...
        const type = FullType(BuiltList, [FullType(int)]);
