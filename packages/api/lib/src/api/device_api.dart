...
class DeviceApi {
  ...
  Future<Response<void>> addDevice({
    required CreateDevice createDevice,
    ...
    try {
      const _type = FullType(CreateDevice);
      _bodyData = _serializers.serialize(createDevice, specifiedType: _type);
  ...
  Future<Response<void>> deleteDevice({
    ...
    final _path = r'/api/v1/devices/{deviceId}'.replaceAll('{' r'deviceId' '}', deviceId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Device>> getDeviceData({
    required int deviceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/devices/{deviceId}/data'.replaceAll('{' r'deviceId' '}', deviceId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<Device>>> getDevices({
    ...
    final _queryParameters = <String, dynamic>{
      if (roomId != null) r'roomId': encodeQueryParameter(_serializers, roomId, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Device>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Device>>> getDevicesData({
    required BuiltList<int> deviceIds,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/devices/data';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'deviceIds': encodeCollectionQueryParameter<int>(_serializers, deviceIds, const FullType(BuiltList, [FullType(int)]), format: ListFormat.multi,),
    };
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> triggerDevice({
    required int deviceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/devices/{deviceId}/trigger'.replaceAll('{' r'deviceId' '}', deviceId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> triggerGroup({
    ...
    final _path = r'/api/v1/devices/groups/{deviceType}'.replaceAll('{' r'deviceType' '}', deviceType.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (roomId != null) r'roomId': encodeQueryParameter(_serializers, roomId, const FullType(int)),
    };
  ...
  Future<Response<void>> updateGroup({
    ...
    final _path = r'/api/v1/devices/groups/{type}'.replaceAll('{' r'type' '}', type.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
