...
class ConfigApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IsInitialized] as data
  ...
  Future<Response<IsInitialized>> isInitialized({
    ...
    final _path = r'/api/v1/initialized';
    ...
    IsInitialized _responseData;

    try {
      const _responseType = FullType(IsInitialized);
